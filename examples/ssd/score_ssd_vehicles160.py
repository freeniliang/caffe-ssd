...
os.chdir("C:\SSD\caffe-ssd-microsoft")#hy added it 0n 20170323
...
train_data = "data/VOCdevkit/trainval_lmdb"#hy changed it 0n 20170323
# The database file for testing data. Created by data/VOC0712/create_data.sh
test_data = "data/VOCdevkit/test_lmdb"#hy changed it 0n 20170323
# Specify the batch sampler.
resize_width = 1300#hy changed it 0n 20170323
resize_height = 1300#hy changed it 0n 20170323
...
model_name = "VGG_vehicles160_{}".format(job_name)

# Directory which stores the model .prototxt file.
save_dir = "models/VGGNet/logos_vehicles160/{}_score".format(job_name)
# Directory which stores the snapshot of trained models.
snapshot_dir = "models/VGGNet/logos_vehicles160/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/VGGNet/logos_vehicles160/{}_score".format(job_name)
# Directory which stores the detection results.
#output_result_dir = "{}/data/VOCdevkit/results/logos_vehicles160/{}_score/Main".format(os.environ['HOME'], job_name)
output_result_dir = "data/VOCdevkit/results/logos_vehicles160/{}_score/Main".format(job_name)
...
name_size_file = "data/VOCdevkit/test_name_size.txt"
# The resume model.
pretrain_model = "{}_iter_{}.caffemodel".format(snapshot_prefix, max_iter)
# Stores LabelMapItem.
label_map_file = "data/VOCdevkit/labelmap_vehicles160.prototxt"
