...
os.chdir("C:\SSD\caffe-ssd-microsoft")
...
save_dir = "models/VGGNet/logos_vehicles160/{}".format(job_name)
# Directory which stores the snapshot of models.
# snapshot_dir = "models/VGGNet/VOC0712/{}".format(job_name)
snapshot_dir = "models/VGGNet/logos_vehicles160/{}".format(job_name)
# Directory which stores the job script and log file.
# job_dir = "jobs/VGGNet/VOC0712/{}".format(job_name)
job_dir = "jobs/VGGNet/logos_vehicles160/{}".format(job_name)
# Directory which stores the detection results.
# output_result_dir = "data/VOC0712/results/{}/Main".format(job_name)
output_result_dir = "data/VOCdevkit/results/{}/Main".format(job_name)
...
num_classes = 2 #hy changed it from 21 to 2
share_location = True
...
num_test_image = 80 #hy changed it from 4952 to 80
test_batch_size = 1
